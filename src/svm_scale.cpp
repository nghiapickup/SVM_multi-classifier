...
{
	printf("Edited LibSVM 3.20 - Scale\n"
...
void output_target(double value,ofstream& fo);
void output(int index, double value,ofstream& fo);
char* readline(FILE *input);
int clean_up(FILE *fp_restore, FILE *fp, const char *msg);

int main_svm_scale(int argc,char **argv)
{
	int i,index;
